...
%    \end{tabularx}
% \end{rpg-quotebox}
% 1. MG: w kantynie jest siwo od tytoniowego dymu
...
%    \end{tabularx}
% \end{rpg-quotebox}
% 2. MG: widzisz wyraźnie, że strażnicy unikają tematu
% Lander: ich nic nie obchodzi, wszystko mają w dupie!
% Kedra: jak typowa straż miejska
% MG: tak, oni tylko zakładają blokady na wozy
% 
% \begin{rpg-quotebox}{}
%    \begin{tabularx}{\columnwidth}{lX}
%    \end{tabularx}
...
%    \end{tabularx}
% \end{rpg-quotebox}
% 4. MG: strażnicy są podejrzliwi i wasz upór zamierzają przegonić młotami bojowymi
...
% MG do Randala: dostajesz w kolano
% Ampoldórëon: I used to be an adventurer like you then...
% MG:... I took a warhammer in the knee
% 
% \begin{rpg-quotebox}{}
%    \begin{tabularx}{\columnwidth}{lX}
%    \end{tabularx}
% \end{rpg-quotebox}
% 6. MG: krasnolud próbuje wykastrować Randala i trafia za 8 pkt. obrażeń
