...
%    \end{tabularx}
% \end{rpg-quotebox}
% 1. Drużyna rozmawiała na temat możliwości czaru teleportacji
% Kedra: czy da się wyteleportować ze swoich ciuchów?
% Ampoldórëon: ale po co? Nie lepiej się rozebrać i zachować slota?
% Kedra: no tak, ale wtedy nie ma efektu
% Lander: mi by się przydał cantrip ściągania zbroi
% Ampoldórëon: mag mógłby zrobić sobie iluzję tego, że nie ma ubrań
% Randal: ale jak ktoś widzi przez iluzję to co?
% Kedra: ale w takim momencie po co?
% Randal: dobra, to miałoby sens w odwrotnej sytuacji, gdyby iluzją były ciuchy
% DM: patrzenie przez iluzje to test na Inta
% Randal: sytuacja: -Przepraszam, czy Pan jest nagi? - Gratuluję! Jest Pan zatrudniony!
% 
% \begin{rpg-quotebox}{}
%    \begin{tabularx}{\columnwidth}{lX}
%    \end{tabularx}
% \end{rpg-quotebox}
% 2. Drużyna szukała pretekstu dla nagłego pojawienia się w mieście - stolicy podziemnych krasnoludów. Proponowali egzotycznych kupców, sprzedawców, przedstawicieli handlowych, koneserów szlachetnych trunków, kolekcjonerów drogich kamieni itd. itp.
% Alchemik (NPC): czy szukanie powrotu na powierzchnię nie jest wystarczającym powodem?
% Ampoldórëon: jasne! Wpierdoliliśmy się tu chuj wie jak i teraz chcemy stąd iść!
% 
% \begin{rpg-quotebox}{}
%    \begin{tabularx}{\columnwidth}{lX}
%    \end{tabularx}
% \end{rpg-quotebox}
% 3. Drużyna walczyła z zaczarowanym płaszczem.
% Lander: podnoszę swój topór bojowy, ruszam w impetem w jego kierunku i krzyczę "Giń szmato!"
% 
% \begin{rpg-quotebox}{}
%    \begin{tabularx}{\columnwidth}{lX}
%    \end{tabularx}
% \end{rpg-quotebox}
% 4.  DM: jak to rzucisz w tym miejscu to obejmiesz też Landera.
% Ampoldórëon: sam powiedziałeś, że mogę Cię bić - chuj ci w dupę Thunderwave z poziomu trzeciego!
% Lander: o nie
% DM: ok, skoro ani płaszcz ani Lander nie zdali testu na zręczność to czar odrzuca was w kierunku płonących półek i zjawa ginie.
% Lander: zostały mi 3 punkty HP
% 
% \begin{rpg-quotebox}{}
%    \begin{tabularx}{\columnwidth}{lX}
%    \end{tabularx}
% \end{rpg-quotebox}
% 5. Randal: rzucam fog cloud, która obejmuje palące się półki by pożar się nie rozprzestrzenił
% Kedra: pff to tylko miejscowe, nie szkoda na to slota?
% Randal: ale to sfletu
% 
% 
...
%    \end{tabularx}
% \end{rpg-quotebox}
% 1. Randal: umiem zrobić mydło
% Lander: zrób je z tego parzącego mchu nazbieranego u krasnoludów. Albo lepiej płyn do higieny intymnej.
% Kedra: tak, o nazwie "Dotyk smoka".
% 
% \begin{rpg-quotebox}{}
%    \begin{tabularx}{\columnwidth}{lX}
%    \end{tabularx}
% \end{rpg-quotebox}
% 2. Lander: szukam zaułku, w który moglibyśmy skręcić
% DM: w pierwszym się ktoś obściskuje, a w drugim...
% Randal: bójka. "O! panowie się już biją, to my dołączymy później"
% 
% \begin{rpg-quotebox}{}
%    \begin{tabularx}{\columnwidth}{lX}
%    \end{tabularx}
% \end{rpg-quotebox}
% 3. Lander i Ampoldórëon postanowili udawać śmietniki pod ścianą obok już istniejącego śmietnika. Czyli obok śmieci zmieszanych stałyby: papier i metal.
% Randal i Kedra postanowili udawać że też się obściskują.
% Kedra: tak, a potem ta dwójka wyskoczy z notami oceniającymi
% Randal: kusi mnie by zawołać do tego śledzącego nas by się przyłączył do trójkąta
% 
% \begin{rpg-quotebox}{}
%    \begin{tabularx}{\columnwidth}{lX}
%    \end{tabularx}
% \end{rpg-quotebox}
% 4. Lander: robię coś głupiego i wyskakuję z zaułka za nim. Łapię go za poły i wciągam z powrotem.
% Ampoldórëon: może mnie tam nie być?!
% DM do Landera: twój atak nie jest zbyt subtelny
% Randal: ale z efektywnością imadła
% K20 na percepcję Randala: 21
% DM do Randala: ty widzisz ten popis
% Randal: ciągnę Kedrę za łokieć z powrotem do zaułka
% Kedra: ale tam już byliśmy...
% Randal: nie skończyłem...
% 
% \begin{rpg-quotebox}{}
%    \begin{tabularx}{\columnwidth}{lX}
%    \end{tabularx}
% \end{rpg-quotebox}
% 5. Randal: przepraszam kapłana Kruczej Królowej za brutalne potraktowanie
% Lander: gdyby był brutalnie potraktowany to już by nie miał zębów
% \begin{rpg-quotebox}{}
%    \begin{tabularx}{\columnwidth}{lX}
%    \end{tabularx}
% \end{rpg-quotebox}
% 6. Drużyna kosztowała lokalne piwo i zastanawiała się czy pili już lepsze.
% Randal: idę do baru i pytam czy to wszystko na co ich stać
% 
% \begin{rpg-quotebox}{}
%    \begin{tabularx}{\columnwidth}{lX}
%    \end{tabularx}
% \end{rpg-quotebox}
% 7. Drużyna zastanawiała się czy umie wycenić szmaragd z którego zdjęli klątwę i połatali do kupy.
% Lander: jedyne co zielone widziałem w życiu to liście
% 
% \begin{rpg-quotebox}{}
%    \begin{tabularx}{\columnwidth}{lX}
%    \end{tabularx}
% \end{rpg-quotebox}
% 8. Nie udało się sprzedaż szmaragdu bo pan jubiler chciał nas orżnąć.
% Lander: może staniemy na targu i krzykniemy "szmaragd na sprzedaż!"?
% Randal: "tylko jedna klątwa na nim była i jest prawie cały"
% Ampoldórëon: hola! Cały! Sam kleiłem!
% 
% \begin{rpg-quotebox}{}
%    \begin{tabularx}{\columnwidth}{lX}
%    \end{tabularx}
% \end{rpg-quotebox}
% 9. Druga próba wycenienia szmaragdu:
% Ampoldórëon: a jak duży jest ten szmaragd w porównaniu do klejnotów koronnych imperium?
% Randal: to są bardzo pokaźnych rozmiarów klejnoty...
% Kedra: bez jaj!
% \begin{rpg-quotebox}{}
%    \begin{tabularx}{\columnwidth}{lX}
%    \end{tabularx}
% \end{rpg-quotebox}
% 10. Otrzymaliśmy ofertę 490 platyn za szmaragd. Bierzemy? Czy tak bardzo potrzebujemy tej kasy?
% Kedra: on miał klątwę! Oczywiście że bierzemy!
% Randal: taaak, jest poleasingowy
% 
% \begin{rpg-quotebox}{}
%    \begin{tabularx}{\columnwidth}{lX}
%    \end{tabularx}
% \end{rpg-quotebox}
% 11. Randal negocjował cenę tarczy i miecza dla Landera
% Randal: a gdyby na tarczy było logo waszego cechu? Albo lepiej - gdyby na ostrzu miecza było Wasze nazwisko? Gdyby to było ostatnie co zobaczy ofiara, czy to nie byłby najlepszy rozgłos waszego fachu?
% Ampoldórëon: to się raczej nie rozniesie...
% NPC: ok. 20 platyny mniej jeśli nie będę musiał tego dłużej słuchać...
% 
% 
...
%    \end{tabularx}
% \end{rpg-quotebox}
% 1. DM: w kantynie jest siwo od tytoniowego dymu
% Randal: a, rozumiem że jest tam mgła wojny?
% 
% \begin{rpg-quotebox}{}
%    \begin{tabularx}{\columnwidth}{lX}
%    \end{tabularx}
% \end{rpg-quotebox}
% 2. DM: widzisz wyraźnie, że strażnicy unikają tematu
% Lander: ich nic nie obchodzi, wszystko mają w dupie!
% Kedra: jak typowa straż miejska
% DM: tak, oni tylko zakładają blokady na wozy
% 
% \begin{rpg-quotebox}{}
%    \begin{tabularx}{\columnwidth}{lX}
%    \end{tabularx}
% \end{rpg-quotebox}
% 3. Lander: nie możemy teraz odpoczywać! Zanim tam pójdziemy oni już umrzą!
% Ampoldórëon: zamierzamy wejść do kanałów pełnych potworów bez odpoczynku mamy marne szanse. Więc <żegnając się> chuj z nimi
% Kedra: i z dupą twoją
% 
% \begin{rpg-quotebox}{}
%    \begin{tabularx}{\columnwidth}{lX}
%    \end{tabularx}
% \end{rpg-quotebox}
% 4. DM: strażnicy są podejrzliwi i wasz upór zamierzają przegonić młotami bojowymi
% Randal: panowie, spokojnie nie musicie nic robić. Wpuśćcie nas do tego tunelu, a tam i tak nas coś sprzątnie i wy będziecie mieć ręce czyste
% NPC-e: a my lubimy
% 
% \begin{rpg-quotebox}{}
%    \begin{tabularx}{\columnwidth}{lX}
%    \end{tabularx}
% \end{rpg-quotebox}
% 5. W tle bitwy z w/w strażnikami słuchaliśmy muzyki ze Skyrim
% DM do Randala: dostajesz w kolano
% Ampoldórëon: I used to be an adventurer like you then...
% DM:... I took a warhammer in the knee
% 
% \begin{rpg-quotebox}{}
%    \begin{tabularx}{\columnwidth}{lX}
%    \end{tabularx}
% \end{rpg-quotebox}
% 6. DM: krasnolud próbuje wykastrować Randala i trafia za 8 pkt. obrażeń
% Randal: pochylam się i wypluwam dwa orzeszki
% Lander: spójrz na to z drugiej strony - teraz możesz wyciągać wyższe tony
% 
% \begin{rpg-quotebox}{}
%    \begin{tabularx}{\columnwidth}{lX}
%    \end{tabularx}
% \end{rpg-quotebox}
% 7. Randal: obrażam go, by obniżyć jego szanse na trafienie "Twoja matka puściła się z elfem!"
% Ampoldórëon, Kedra: ej! Co masz do elfów?!
% DM: friendly fire
% 
% \begin{rpg-quotebox}{}
%    \begin{tabularx}{\columnwidth}{lX}
%    \end{tabularx}
% \end{rpg-quotebox}
% 8. Randal w ferworze walki: killing word w Ampoldórëona
% Kedra: dobijasz go?
% 
...
%    \end{tabularx}
% \end{rpg-quotebox}
% 1. DM: Lander, ty widzisz że stalagmity przed wami dziwnie się ruszają
...
% DM: Ampoldórëon twoja kolej, uwaga 2 punkty życia w natarciu
% 
% \begin{rpg-quotebox}{}
%    \begin{tabularx}{\columnwidth}{lX}
%    \end{tabularx}
...
%    \end{tabularx}
% \end{rpg-quotebox}
% 6. DM: Kedra, ten strzał był śmiertelny
...
%    \end{tabularx}
% \end{rpg-quotebox}
% 7. DM: Lander, podczas odpoczynku z korytarza obok was zaczynasz słyszeć mlaskanie i przesuwanie się czegoś mokrego po podłożu. Po chwili widzisz, że źródłem dźwięku jest Galaretowaty Sześcian.
...
% DM: nie, to jest raczej coś w stylu plomk, plomk, plomk, "jaka dziwna ściana", plomk, plomk
% 
% \begin{rpg-quotebox}{}
%    \begin{tabularx}{\columnwidth}{lX}
%    \end{tabularx}
...
% K20 na percepcję: 21
% DM: widzisz dwa szkielety, zardzewiały topór i coś co się błyszczy ale nie jesteś w stanie tego zidentyfikować
% \begin{rpg-quotebox}{}
%    \begin{tabularx}{\columnwidth}{lX}
%    \end{tabularx}
% \end{rpg-quotebox}
% 9. Lander: cicho ubieram zbroję
% DM: test na sleight of hand poproszę
...
%    \end{tabularx}
% \end{rpg-quotebox}
% 11. DM: ok, trochę go już nadwyrężyliście.
...
%    \end{tabularx}
% \end{rpg-quotebox}
% 12. DM: po śmierci sześcian zamienił się w kwasową kałużę, która rozpuściła leżące nieopodal ciała mackowych stalagmitów. Wy znajdujecie w nim wyglądający na magiczny naszyjnik.
...
% DM: Ampoldórëon ty wiesz, że one wysysają inteligencję
% 
% \begin{rpg-quotebox}{}
%    \begin{tabularx}{\columnwidth}{lX}
%    \end{tabularx}
...
%    \end{tabularx}
% \end{rpg-quotebox}
% 6. DM szykował pole bitwy podczas gdy rozmawialiśmy OOC o rasizmie wobec czarnoskórych występującym w grach.
...
%    \end{tabularx}
% \end{rpg-quotebox}
% 7. DM: Randal otrzymujesz 13 punktów obrażeń nekrotycznych
% Kedra: och, rozkładasz się w oczach
% DM: taaak - zaczynasz lekko śmierdzieć
...
% DM: elf atakuje Shovraka i uzyskuje wynik 19 na trafienie
% Randal: gwiżdżę wyzywająco i odejmuję mu 8
% DM: ok, ale modyfikator to +8 więc i tak trafia
% Shovrak: kurwa mam 18 pancerza
% Elf zadał poważne obrażenia paladynowi
% Shovrak: zostało mi 1 hp
% DM cytując z "Asterix i Obelix: Misja Kleopatra": ten grobowiec będzie waszym grobowcem!
...
%    \end{tabularx}
% \end{rpg-quotebox}
% 4. DM: zombiak postanowił walnąć swoją gnijącą ręką w Ampoldórëona
...
% DM: przypominam że osoby z zewnątrz nie widzą "zawartości" chatki
...
%    \end{tabularx}
% \end{rpg-quotebox}
% 2. DM do Randala: wampir próbuje cię podrapać i trafia
...
% DM: cóż... te dwie puszki (Lander i Shovrak) trudno trafić, a Kedra i Ampoldórëon są zawsze gdzieś w kosmosie
% 
% \begin{rpg-quotebox}{}
%    \begin{tabularx}{\columnwidth}{lX}
%    \end{tabularx}
