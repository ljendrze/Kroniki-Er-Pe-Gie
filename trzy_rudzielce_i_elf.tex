...
%    \begin{tabularx}{\columnwidth}{lX}
%    Walka z żywiołakami wody
% Garret: próbuję osuszyć go ręcznikiem!
...
%    \end{tabularx}
% \end{rpg-quotebox}
9. Na pytanie czy żywiołaki są odporne na obrażenia fizyczne
DM: Garret twoje pięści są magiczne?
Garret: jeszcze nie...
...
%    \end{tabularx}
% \end{rpg-quotebox}
10. Żywiołak obrał na cel Garreta:
Garret: ciekawe, czy ci sie to uda...
DM: 24 na trafieniu
Garret:... skurwysynu
...
%    \end{tabularx}
% \end{rpg-quotebox}
11. Stan walki z żywiołakami:
DM: wysuszyliście w ponad połowie jednego żywiołaka
...
%    \end{tabularx}
% \end{rpg-quotebox}
12. Jeden z żywiołaków wchłonął Garreta w swoje wodne trzewia:
DM: gwoli uściślenia, jak będziecie bić żywiołaka Garret też oberwie
Vivien: dobra jebać, potem się go wskrzesi w końcu znam medycynę
Calion <szykując potężny czar>: no to skoro nasz druid tak mówi to sorry bracie
...
%    \end{tabularx}
% \end{rpg-quotebox}
13. Drużyna zjeżdża tunelem w dół, który kończy się lądowaniem z dwóch metrów na gołym kamieniu. Calion jechał pierwszy i postanowił rzucić na siebie czar powolnego spadania.
DM: jesteś pewien że chcesz go rzucić?
Calion: oczywiście! Tam są dwa metry!
DM: OK. Po chwili na pełnej kurwie nadlatuje Garret.
...
%    \end{tabularx}
% \end{rpg-quotebox}
14. Sztuka dyplomacji w praktyce z potworami:
Viv w jezyku Sylvan: odejdź stąd Encie, a nic ci nie zrobimy. Nie jesteśmy wrogami.
Ent: Nie.
...
%    \end{tabularx}
% \end{rpg-quotebox}
15. Duch elfa zabił Vivien. Po tym Garret wyrzucił pod rząd 5 trafień krytycznych.
DM: co tu sie właśnie odbyło??
Matheus: jakby nie patrzeć to ten elf zabił jego kobietę...
