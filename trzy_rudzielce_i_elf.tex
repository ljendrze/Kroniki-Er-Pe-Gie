...
\begin{rpg-quotebox}{Z cyklu ,,grzechy popełnione ustami''}
   \begin{tabularx}{\columnwidth}{lX}
...
\begin{rpg-quotebox}{}
   \begin{tabularx}{\columnwidth}{lX}
      ...
      \textbf{Yeleda:} & samokrytycznie: tylko końcówki włosów mam blond. Mózg się jeszcze broni!\\
   \end{tabularx}
\end{rpg-quotebox}
...
%    \end{tabularx}
% \end{rpg-quotebox}
Drużyna rzucała kośćmi którą opcję drogi objąć i rzucała nimi tak długo aż wypadło to co chcieli.
...
%    \end{tabularx}
% \end{rpg-quotebox}
\textbf{Vivien:} & moja propozycja jest taka: weźmy dolinę konwalii tam mamy pewność, że dolina rozwali i nas i pakt. We wszystkich innych opcjach pakt ma przewagę.\\
\textbf{Drużyna:} & Zgoda!\\
% \begin{rpg-quotebox}{}
%    \textit{}\\
%    
...
\textbf{Garret:} & obsyp się żwirem i udawaj drogę\\
% \begin{rpg-quotebox}{}
%    \textit{}\\
%    
%    \begin{tabularx}{\columnwidth}{lX}
...
\textbf{NPCe:} & Co chcesz palić? Nie, nie mamy.\\
\textbf{Łukasz:} & karczmę na przykład.\\
% \begin{rpg-quotebox}{}
%    \textit{}\\
%    
%    \begin{tabularx}{\columnwidth}{lX}
...
%    \end{tabularx}
% \end{rpg-quotebox}
\textbf{Yeleda:} & okrążam karczmę tak szybko, że teraz ja ich śledzę.\\
% \begin{rpg-quotebox}{}
%    \textit{}\\
%    
%    \begin{tabularx}{\columnwidth}{lX}
...
%    \end{tabularx}
% \end{rpg-quotebox}
\textbf{DM:} & w karczmie jest 10 najemników i dwa elfy słoneczne magowie. Rzućcie na inicjatywę.\\
\textbf{Łukasz:} & czy mamy robić nowe postaci?\\
...
%    \end{tabularx}
% \end{rpg-quotebox}
\textbf{DM:} & myślę, że karczmarka ma większy problem z 11 trupami\\
\textbf{Vivien:} & kiepska reklama\\
\textbf{Garret z} & pomysłem na szyld: "U nas zaliczysz zgona!", "U nas zalejesz się w trupa!"\\


 25.11.2017:
 1. Vivien: mamy już 5-ty lvl, a ty jeszcze nic nie uwarzyłeś!
 Garret: z rzeczy do warzenia piwa mam tylko umiejętność

 2. Calion: czyli wszyscy w transie, a tylko Yeleda śpi śpi
 Vivien: czyli jedyna osoba, która mogłaby ci wbić nóż w plecy gdy śpisz
 Yeleda: point!

 3. Calion: rozświetlam swój sztylet
 Garret: pnącza trzeba było rozświetlić!
 Mu: byłby światłowód

 4. Garret: skaczę na potwora
 ...
 5. DM: potwór po ataku Garreta ma do wysokości ud solidne wgniecenia w korze

 6. Vivien zmieniła się w tygrysa i chciała powalić potwora, ale zamiast tego ten ją ogłuszył potężnym uderzeniem
 Garret: czy medycyna liczy się też jako weterynaria?

 7. Yeleda dobiła atakujące pnącze zręcznym strzałem z ukrycia.
 Calion: hey! bullshit!
 Garret: komu ty kibicujesz?

 8. Calion: ale moment, co my chcemy zrobić?
 ...
 9. Drużyna zastanawiała się czy przebijać się przez kolejne piętra zarośniętej latarni morskiej czy wybrać szybszy sposób.
 Calion: proponuję zejść na dół przez pnącza, a jak coś to wrócimy na górę i wyskoczymy przez okno

 10. Vivien rozmawiała z NPC-em druida, którego odratowali z latarni. Rozmowa polegała na wymienianiu informacji na temat panującej inwazji oraz planów co do dalszych ruchów.
 Garret (w tle do DMa): podpaliliśmy pnącza!

 11. Vivien: leczę Garreta z 3-ego slota!
 DM: to jest miłość!
 Calion, Yeleda: ona przecież mówiła, że nie legnie z niziołkiem
 Vivien: mogę go leczyć, nie muszę całować
 12. DM: Garret po oberwaniu kamieniem od Giganta ma na czole odbity stopień.
 13. Drużyna zdecydowała zejść do kanałów. DM: ścieków będzie tak po kolana, Garret będzie miał do pasa
 14. DM ma problem z wymawianiem literki R: tu był magazyn przemycanych dóbr. Yeleda: dupy przemycali - rude, blondynki co tylko chcesz
 15. Korytarz zagradzał potwór spaghetti w wersji ciernistych lian. Drużyna zastanawiała się czy z nim walczyć, czy iść do celu okrężną drogą. Yeleda: ok czyli bitka! Ukrywam się!
 16. Potwór był dość mocnym przeciwnikiem i powalił Garreta tam gdzie stał - czyli w śmierdzącym ścieku DM: jesteś nieprzytomny i w dodatku topisz się w brei Garret: jestem mały i zwinny, na pewno dryfuję DM: twarzą w dół
 17. Calion miał do wyboru dobić potwora lub ustabilizować wykrwawiającego się Garreta i narazić się na okazjonalny atak potwora. Jego dobry charakter wybrał za niego: Calion: stabilizuję Garreta umiejętnością Medycyna K20: 1 DM: Dobiłeś go. DM po chwili: Dobra, niech będzie. Już się nie wykrwawia.
 18. DM: Garret wspina się po drabinie niczym rącza łania.
 19. Vivien (OOC do wkurzających ją NPC-ów): już dawno zrobiłabym wam z kutasów pnącza Garret: Pnącia! Kutaliany!
 20. Przewidywana obserwacja straży miejskiej, która puściła drużynę wolno, ale obiecała, że nie spuści z nich oka: Ta banda wkradła się do kanałów, przedarła się przez ich śmierdzące wnętrza, pobiła potwory z pnączy tylko po to by włamać się do spalonej kamienicy i urządzić sobie w niej melinę! Nie. Oni nie stanowią zagrożenia dla miasta.
