...
%    \end{tabularx}
% \end{rpg-quotebox}
% 1. Vivien w odpowiedzi na niski rzut Garreta: kurna, nie wiem czy mu pomóc, czy go pomacać
% 
% \begin{rpg-quotebox}{}
%    \begin{tabularx}{\columnwidth}{lX}
%    \end{tabularx}
% \end{rpg-quotebox}
% 2. GM: ktoś musi karczować dżunglę
% Vivien: ja jestem druidem - nie mam niczego ostrego!
% Calion: ja mogę palić, ale tego chyba nie chcecie
% 
% \begin{rpg-quotebox}{}
%    \begin{tabularx}{\columnwidth}{lX}
%    \end{tabularx}
% \end{rpg-quotebox}
% 3. GM: Calion, Vivien, Tollena (npc) poproszę rzut obronny na dex. Hm... czy ja sobie właśnie zabiłam npca?
% 
% \begin{rpg-quotebox}{}
%    \begin{tabularx}{\columnwidth}{lX}
%    \end{tabularx}
% \end{rpg-quotebox}
% 4. Garret: szukam jego słabego punktu
% Vivien: masz wysoko medycynę - może wiedza z anatomii?
% Calion: Viv... w szkołach nie uczą anatomii... smoków!
% 
% \begin{rpg-quotebox}{}
%    \begin{tabularx}{\columnwidth}{lX}
%    \end{tabularx}
% \end{rpg-quotebox}
% 5. Calion: odsuwam się w krzaki
% Garret: ja jestem w krzakach i mogę się tam zesrać ze strachu
% Vivien: ale już nie masz prywatności
% Garret: zajęte!
% Calion: macie problemy...
% 
% \begin{rpg-quotebox}{}
%    \begin{tabularx}{\columnwidth}{lX}
%    \end{tabularx}
% \end{rpg-quotebox}
% 6. Garret: idę w kierunku krzaków
% Yeleda: ej! ja tam jestem i... coś robię
% 
% \begin{rpg-quotebox}{}
%    \begin{tabularx}{\columnwidth}{lX}
%    \end{tabularx}
% \end{rpg-quotebox}
% 7. GM: Garret w 10 sekund wstał, przewrócił gościa, przebiegł 20 stóp i przewrócił jeszczekobietę
% Calion: nerwowy...
% Vivien: tornado
% 
% \begin{rpg-quotebox}{}
...
%    \end{tabularx}
% \end{rpg-quotebox}
% 8. GM: rudobrody patrzy na ciebie swoim przerażonym ostatnim punktem życia
% 
% \begin{rpg-quotebox}{}
%    \begin{tabularx}{\columnwidth}{lX}
%    \end{tabularx}
% \end{rpg-quotebox}
% 9. NPC do Garreta: zdajesz sobie sprawę, że jeśli będziesz chciał zabić wszystkich którzy kiedyś kogoś zabili będziesz musiał sprzątnąć 3/4 wysp?
% Yeleda [nonszalancko]: mamy czas...
% 
% \section*{18 listopada 2018}
% 
% 18/11/2018
% \begin{rpg-quotebox}{}
%    \begin{tabularx}{\columnwidth}{lX}
%    \end{tabularx}
% \end{rpg-quotebox}
% 1. DM: skorpionokrab atakuje pierwszymi szczypcami
% Yeleda: ja myślalałam że się mówi pierwszymi skrzypcami
% 
% \begin{rpg-quotebox}{}
%    \begin{tabularx}{\columnwidth}{lX}
%    \end{tabularx}
% \end{rpg-quotebox}
% 2. DM: Calion i Vivien teoretycznie się uczą...
% Calion, Vivien: hola!
% Garret: no właśnie bo teraz coś wchodzi...
% Vivien: myślę, że teraz ktoś będzie pływał za łódką. Garret jesteś mały więc łatwo mi będzie cię wziąć za klapy i wyrzucić za burtę.
% Calion: on ma bonusy do uników
% Vivien: no ja myślę, że po tym co powiedział to Ty mi w tym pomożesz...
% Calion: a co powiedział? Vivien powtórzyła.
% Calion: dobra! To na trzy... czte... ry!
% 
% \begin{rpg-quotebox}{}
%    \begin{tabularx}{\columnwidth}{lX}
%    \end{tabularx}
% \end{rpg-quotebox}
% 3. Garret zirytowany pytaniami o istnienie jego śpiwora:  noż kurwa jo mom śpiwór kupiłżech se nowy wcześniej!
% 
% \section*{23 listopada 2018}
% 
% 23/11/2018
% \begin{rpg-quotebox}{}
%    \begin{tabularx}{\columnwidth}{lX}
%    \end{tabularx}
% \end{rpg-quotebox}
% 1. Drużyna dostała magazyn za karczmą jako swój pokój. Na drzwiach znajdował się numer 6.
% Vivien: cholera, parzysta - to przynosi pecha
% Yeleda: mi tam wisi parzysta czy nie parzysta, ale jeśli coś jest numerowane to zawsze wybieram 9.
% Garret: chcę szybko i niepostrzeżenie obrócić drzwi.
% DM: poproszę test na siłę i ukrywanie się
% K20: 20 i 21
% DM: Garret bezszelestnie wyjął drzwi z zawiasów i obrócił je do góry nogami. Teraz się nie zamykają, ale mają numer 9. Po tym spojrzał wyczekująco na ciebie, Vivien.
% 
% \begin{rpg-quotebox}{}
%    \begin{tabularx}{\columnwidth}{lX}
%    \end{tabularx}
% \end{rpg-quotebox}
% 2. DM: W nocy do waszego pokoju przez wstawione byle jak drzwi wpadł zataczając się pijany gnom. Wpadł i zasnął na podłodze roztaczając wokół siebie odór.
% Vivien: proponuję wynieść go na zewnątrz i się nie przejmować
% Garret: no weź! Jeszcze ktoś go tam ograbi.
% Yeleda: OK to ja go ograbię najpierw i potem go wystawimy
